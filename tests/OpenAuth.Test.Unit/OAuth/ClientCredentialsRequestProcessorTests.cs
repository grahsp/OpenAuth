...
// public class ClientCredentialsRequestProcessorTests
// {
//     private readonly ISecretQueryService _secretQueryService;
//     private readonly ClientCredentialsRequestProcessor _issuer;
//
//     public ClientCredentialsRequestProcessorTests()
//     {
//         _secretQueryService = Substitute.For<ISecretQueryService>();
//         _issuer = new ClientCredentialsRequestProcessor(_secretQueryService);
//     }
//
//     
...
//
//         // Act
//         var result = await _issuer.ProcessAsync(request);
//
//         // Assert
...
//             .Returns(true);
//
//         await _issuer.ProcessAsync(request, token);
//
