...
public class AuthorizationCodeValidatorTests
{
    ...
    public async Task ValidateAsync_WhenPkceIsPresent_ClientSecretIsIgnored()
    {
        ...
        Assert.Equal(DefaultValues.Scopes, result.ApiScopes.ToString());
    }
    ...
    public async Task ValidateAsync_WhenOpenIdScopes_ReturnValidationResult()
    {
        ...
        Assert.Equal(DefaultValues.Audience, result.AudienceName.Value);
        Assert.Equal(DefaultValues.Scopes, result.ApiScopes.ToString());
        Assert.Equal("openid", result.OidcScopes.ToString());
    }
    ...
    [Fact]
    public async Task ValidateAsync_WithMissingAudience_ThrowsInvalidRequestException()
    {
        var ctx = _validContext with
        {
            Command = _validContext.Command with
    ...
    [Fact]
    public async Task ValidateAsync_WithInvalidAudience_ThrowsInvalidScopeException()
    {
        var ctx = _validContext with
        {
            Command = _validContext.Command with
            {
                RequestedAudience = AudienceName.Create("invalid-audience")
            }
        };
    ...
    [Fact]
    public async Task ValidateAsync_WithMissingOpenIdScope_ThrowsInvalidScopeException()
    {
        var ctx = _validContext with
        {
            AuthorizationGrant = new AuthorizationGrantBuilder()
    ...
    [Fact]
    public async Task ValidateAsync_WithMissingNonce_ThrowsInvalidGrantException()
    {
