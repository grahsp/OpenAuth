        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    AllowedGrantTypes = table.Column<string>(type: "nvarchar(2000)", maxLength: 2000, nullable: false),
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        name: "FK_ApiPermissions_ApiResources_ApiResourceId",
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    table.PrimaryKey("PK_ClientApiAccess", x => x.Id);
                    table.ForeignKey(
                        name: "FK_ClientApiAccess_Clients_ClientId",
                        column: x => x.ClientId,
            ...
            migrationBuilder.CreateIndex(
                name: "IX_ApiPermissions_ApiResourceId",
                table: "ApiPermissions",
                column: "ApiResourceId");

            migrationBuilder.CreateIndex(
                name: "IX_ApiResources_Audience",
                table: "ApiResources",
                column: "Audience",
                unique: true);
            ...
            migrationBuilder.CreateIndex(
                name: "IX_ClientApiAccess_ClientId",
                table: "ClientApiAccess",
                column: "ClientId");
