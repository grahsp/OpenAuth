...
public interface ISigningKeyRepository
{
    ...
    Task<SigningKey?> GetCurrentAsync(DateTimeOffset now, CancellationToken cancellationToken = default);
    Task<IEnumerable<SigningKey>> GetAllAsync(CancellationToken cancellationToken = default);
    Task<IEnumerable<SigningKey>> GetActiveAsync(DateTimeOffset now, CancellationToken cancellationToken = default);
