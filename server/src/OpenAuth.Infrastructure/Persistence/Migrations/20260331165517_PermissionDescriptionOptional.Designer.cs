...
namespace OpenAuth.Infrastructure.Persistence.Migrations
{
    ...
    [Migration("20260331165517_PermissionDescriptionOptional")]
    partial class PermissionDescriptionOptional
    {
        /// <inheritdoc />
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("OpenAuth.Domain.ApiResources.ApiResource", b =>
                {
                    b.Property<Guid>("Id")
                        .HasColumnType("uniqueidentifier");
            ...
            modelBuilder.Entity("OpenAuth.Domain.ApiResources.ApiResource", b =>
                {
                    b.OwnsMany("OpenAuth.Domain.ApiResources.ValueObjects.Permission", "Permissions", b1 =>
                        {
                            b1.Property<Guid>("Id")
                                .ValueGeneratedOnAdd()
                                .HasColumnType("uniqueidentifier");
