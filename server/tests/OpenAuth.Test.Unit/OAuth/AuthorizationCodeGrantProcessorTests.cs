...
//
//     public AuthorizationCodeGrantProcessorTests()
//     {
//         _grantStore = Substitute.For<IAuthorizationGrantStore>();
//         
//         _validator = Substitute.For<IAuthorizationCodeValidator>();
//         _sut = new AuthorizationCodeGrantProcessor(_grantStore, _validator);
//     }
//
