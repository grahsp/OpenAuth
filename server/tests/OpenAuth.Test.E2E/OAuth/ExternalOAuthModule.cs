...
public class ExternalOAuthModule
{
	...
	public ExternalOAuthModule(HttpClient httpClient, RegisteredClientResponse registered)
	{
	...
	public async Task<AuthorizeResult> AuthorizeAsync(Action<AuthorizeUriBuilder>? configure = null)
	{
		...
		var response = await _httpClient.GetAsync((string?)uri);
