...
namespace OpenAuth.Infrastructure.Tests;


[Collection("sqlserver")]
public class ClientServiceIntegrationTests : IAsyncLifetime
{
    private readonly SqlServerFixture _fx;
    public ClientServiceIntegrationTests(SqlServerFixture fx) => _fx = fx;    
    ...
    public class GetClient(SqlServerFixture fx) : ClientServiceIntegrationTests(fx)
    {
        [Fact]
    ...
    public class RegisterClient(SqlServerFixture fx) : ClientServiceIntegrationTests(fx)
    {
        [Fact]
    ...
    public class RenameClient(SqlServerFixture fx) : ClientServiceIntegrationTests(fx)
    {
        [Fact]
    ...
    public class DeleteClient(SqlServerFixture fx) : ClientServiceIntegrationTests(fx)
    {
        [Fact]
    ...
    public class ClientEnabled(SqlServerFixture fx) : ClientServiceIntegrationTests(fx)
    {
        [Fact]
    ...
    public class GrantScopes(SqlServerFixture fx) : ClientServiceIntegrationTests(fx)
    {
    ...
    public class RevokeScopes(SqlServerFixture fx) : ClientServiceIntegrationTests(fx)
    {
        private Scope Read { get; } = new Scope("read");
        private Scope Write { get; } = new Scope("write");
    ...
    public class RevokeAudience(SqlServerFixture fx) : ClientServiceIntegrationTests(fx)
    {
        private Scope Read { get; } = new Scope("read");
        private Scope Write { get; } = new Scope("write");
    ...
    public class AddSecret(SqlServerFixture fx) : ClientServiceIntegrationTests(fx)
    {
        [Fact]
    ...
    public class RevokeSecret(SqlServerFixture fx) : ClientServiceIntegrationTests(fx)
    {
        [Fact]
    ...
    public class RemoveSecret(SqlServerFixture fx) : ClientServiceIntegrationTests(fx)
    {
        [Fact]
    ...
    public class AddSigningKey(SqlServerFixture fx) : ClientServiceIntegrationTests(fx)
    {
        [Fact]
    ...
    public class RevokeSigningKey(SqlServerFixture fx) : ClientServiceIntegrationTests(fx)
    {
        [Fact]
    ...
    public class RemoveSigningKey(SqlServerFixture fx) : ClientServiceIntegrationTests(fx)
    {
        [Fact]
